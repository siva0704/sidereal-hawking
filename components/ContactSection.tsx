  ...
  const contactInfo = [
    {
      icon: '📧',
      title: 'Email',
      value: 'contact@sbinfraprojects.com',
      link: 'mailto:contact@sbinfraprojects.com',
    },
    {
      icon: '📞',
      title: 'Phone',
    ...
    },
    {
      icon: '📍',
      title: 'Address',
      value: '11/12 Construction Avenue, Building No. 04, Bangalore',
      link: null,
    },
  ];
    ...
    >
      ...
      <div className={`container mx-auto relative z-10 ${getContainerPaddingClasses()}`}>
        ...
        <div className="text-center mb-12 md:mb-16">
          <h2
            className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
          >
            Get In <span className="text-gold">Touch</span>
          </h2>
          <p
            className={`text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
          >
        ...
        {/* Additional CTA */}
        <div
          className={`text-center mt-12 md:mt-16 px-4 transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
        >
          <p className="text-sm sm:text-base text-gray-400 mb-4">
            Prefer to talk? Give us a call at{' '}
            <a href="tel:+911234567890" className="text-gold hover:underline font-semibold">
              +91 123 456 7890
            </a>
          </p>
